...
const StyleGuide = function StyleGuide(props) {
  ...
  return (
    ...
    <Stack spacing="16">
      <Stack spacing="8">
        <Heading as="h1" size="2xl">Headings</Heading>
        <Stack spacing="2">
          <Heading as="h1" size="2xl">H1 style</Heading>
          <Heading as="h2" size="xl">H2 style</Heading>
          <Heading as="h3" size="lg">H3 style</Heading>
          <Heading as="h4" size="md">H4 style</Heading>
          <Heading as="h5" size="sm">H5 style</Heading>
          <Heading as="h6" size="xs">H6 style</Heading>
        </Stack>
      </Stack>

      <Stack spacing="8">
        <Heading as="h1" size="2xl">Teaser</Heading>
        ...
        <Teaser
          ...
          media={{ url: 'http://lorempixel.com/400/200/technics/2/', alt: ' le alt' }}
          href="/articles/[slug]"
